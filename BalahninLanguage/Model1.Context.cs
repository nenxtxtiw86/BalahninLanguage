...
namespace BalahninLanguage
{
    ...
    public partial class BalahninLanguageEntities : DbContext
    {
        public static BalahninLanguageEntities _context;
        public static BalahninLanguageEntities GetContext()
        {
            if (_context == null)
        ...
        public BalahninLanguageEntities()
            : base("name=BalahninLanguageEntities")
        {
        }
